    ...
    <Container maxWidth="xl" className={styles.container}>
      <Box height={"13%"}>
        ...
        <Box className={styles.first_part_inputs}>
          ...
          <FormControl sx={{ m: 1, minWidth: 120, width: "20%", alignSelf: "end" }} size="small">
        ...
        <Grid className={styles.grid_card} xs={6}>
          <Box className={styles.container_info}>
            ...
            <FormControl
              ...
              size="small"
            >
              <InputLabel id="select_forecast1_hc">{"Pronostico"}</InputLabel>
              <Select
        ...
        <Grid className={styles.grid_card} xs={6}>
          <Box className={styles.container_info}>
            ...
            <FormControl
              ...
              size="small"
            >
              <InputLabel id="select_forecast2_hc">{"Pronostico"}</InputLabel>
              <Select
